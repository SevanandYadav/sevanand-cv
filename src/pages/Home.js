      ...
      <section id="contact">
        ...
        <div className="contact-content">
          ...
          <div className="contact-links">
            <a href="mailto:sevanandyadav@gmail.com" className="contact-link" title="Email">
            ...
            <a href="https://github.com/SevanandYadav" className="contact-link" title="GitHub">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://bitbucket.org/SevanandYadav/workspace/projects/" className="contact-link" title="Bitbucket">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
